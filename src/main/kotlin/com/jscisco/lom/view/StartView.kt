...
import com.jscisco.lom.dungeon.strategies.BSPTreeGenerationStrategy
...
class StartView() : BaseView() {
    ...
    override fun onDock() {
        ...
        jumpIntoDungeon.onMouseReleased {
            ...
            val dungeon = DungeonBuilder(dungeonSize, strategy = BSPTreeGenerationStrategy(dungeonSize), player = EntityFactory.newPlayer())
